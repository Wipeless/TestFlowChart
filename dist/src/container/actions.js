...
exports.onDragNode = function (_a) {
    ...
    return function (chart) {
        ...
        if (nodechart) {
            chart.nodes[id] = __assign({}, nodechart, { position: config && config.snapToGrid
...
//   identity;
exports.onDragCanvasStop = function () { return function (chart) {
    for (var key in chart.nodes) {
        var node = chart.nodes[key];
        node.position = {
