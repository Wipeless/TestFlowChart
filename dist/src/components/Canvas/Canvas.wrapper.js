...
var CanvasWrapper = /** @class */ (function (_super) {
    ...
    function CanvasWrapper() {
        ...
        _this.updateSize = function () {
            var _a = _this.state, offsetX = _a.offsetX, offsetY = _a.offsetY, width = _a.width, height = _a.height;
            ...
            if (el) {
                ...
                if (rect.left !== offsetX || rect.top !== offsetY) {
    ...
    CanvasWrapper.prototype.render = function () {
        var _a = this.props, config = _a.config, ComponentInner = _a.ComponentInner, ComponentOuter = _a.ComponentOuter, position = _a.position, onDragCanvas = _a.onDragCanvas, onDragCanvasStop = _a.onDragCanvasStop, children = _a.children, onCanvasClick = _a.onCanvasClick, onDeleteKey = _a.onDeleteKey, onCanvasDrop = _a.onCanvasDrop;
        var _b = this.state, offsetX = _b.offsetX, offsetY = _b.offsetY;
        return (React.createElement(CanvasContext_1.default.Provider, { value: { offsetX: offsetX, offsetY: offsetY } },
            React.createElement(ComponentOuter, { config: config, ref: this.ref },
                React.createElement(react_draggable_1.default, { axis: "both", position: position, grid: [1, 1], onDrag: function (event, data) { return onDragCanvas({ config: config, event: event, data: data }); }, onStop: function (event, data) { return onDragCanvasStop({ config: config, event: event, data: data }); }, disabled: config.readonly },
